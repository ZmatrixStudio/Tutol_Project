                    ...
                    {state == "login" && (
                        <div id="form-login" className="space-y-6 smooth-transition opacity-100 transform translate-x-0 block">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button className="flex items-center justify-center space-x-2 py-2.5 border border-slate-200 rounded-xl text-xs font-medium text-slate-700 bg-white hover:bg-slate-50 active:scale-95 smooth-transition shadow-sm">
